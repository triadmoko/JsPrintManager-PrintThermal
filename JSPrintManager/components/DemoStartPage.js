                ...
                <div>
                    ...
                    <div className="row">
                        <div className="col-sm-6">
                            ...
                            <p>
                                Manage and print through <strong>IPP (Internet Printing Protocol)</strong>. Send IPP JSON messages and get response from the IPP enabled device.
                            </p>
                            <button className="btn btn-danger" onClick={() => this.props.setSample(18)}>
                                TRY NOW
                            </button>
                        </div>
                        <div className="col-sm-6">
            ...
            demoContent = (
                ...
                <div className="row">
                    ...
                    <div className="col-sm-4">
                        ...
                        <p>
                            Manage and print through <strong>IPP (Internet Printning Protocol)</strong>. Send IPP JSON messages and get response from the IPP enabled device.
                        </p>
                        <button className="btn btn-danger" onClick={() => this.props.setSample(18)}>
                            TRY NOW
                        </button>
